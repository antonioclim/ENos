...
| Tool | Purpose | CLI |
|------|---------|-----|
| `S02_01_autograder.py` | Automated homework evaluation | Yes |
| `S02_02_quiz_generator.py` | Generate randomized quizzes | Yes |
| `S02_03_report_generator.py` | Create reports | Yes |
