# 📁 Lecture 17 Documentation — Kernel Programming (Supplementary)

> **Location:** `05_LECTURES/17supp-Kernel_Level_OS_Programming/docs/`  
> **Topic:** Kernel modules, device drivers, eBPF
...
| `C17_03_DISCUSSION_QUESTIONS.md` | Peer instruction discussion questions |
| `C17_04_STUDY_GUIDE.md` | Self-study guide and key concepts |
...
```bash
# Linux/WSL
xdg-open 17ex1_-_Kernel_Module_Lifecycle.html
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/17supp-Kernel_Level_OS_Programming/docs/C17_05_FORMATIVE_ASSESSMENT.yaml
```
...
*Lecture 17 of 18 (Supplementary)*
