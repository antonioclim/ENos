...
> **Topic:** Namespaces, cgroups, overlay filesystem
...
| File | Description |
|------|-------------|
| `16ex1_-_Namespaces_Visualizer.html` | PID, network, mount namespace isolation |
| `16ex2_-_Cgroups_Limiter.html` | CPU, memory resource limiting |
| `16ex3_-_Overlay_FS_Layers.html` | Container image layering visualization |

### Formative Assessment (YAML)

| File | Description |
|------|-------------|
| `C16_05_FORMATIVE_ASSESSMENT.yaml` | Formative assessment quiz (Bloom-distributed) |

### Pedagogical Documentation

| File | Purpose |
|------|---------|
| `C16_01_COURSE_PLAN.md` | Learning objectives and session timing |
| `C16_02_CONCEPT_MAP.md` | Visual topic relationships |
| `C16_03_DISCUSSION_QUESTIONS.md` | Peer instruction discussion questions |
| `C16_04_STUDY_GUIDE.md` | Self-study guide and key concepts |
...
```bash
# Linux/WSL
xdg-open 16ex1_-_Namespaces_Visualizer.html
...
```bash
cd ../../SEM01/formative/
python3 quiz_runner.py --file ../../05_LECTURES/16supp-Advanced_Containerisation/docs/C16_05_FORMATIVE_ASSESSMENT.yaml
```
...
*Lecture 16 of 18 (Supplementary)*
