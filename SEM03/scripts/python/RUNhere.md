...
| Tool | Purpose | CLI |
|------|---------|-----|
| `S03_01_autograder.py` | Automated homework evaluation | Yes |
| `S03_02_quiz_generator.py` | Generate randomized quizzes | Yes |
| `S03_03_report_generator.py` | Create reports | Yes |
